...
{
   Print("LIVE005 FINAL M2 | ",event," | ",detail);
...
int OnInit()
{
   ...
   f_log=FileOpen("XAU_M2_LIVE_005_FINAL_LOG.csv",FILE_READ|FILE_WRITE|FILE_CSV|FILE_ANSI|FILE_SHARE_READ,',');
   ...
   Log("NOTE","FINAL parity build: setup pricing/order mirrors MULTI_TF validator; own-Magic MAX1; live 0.01 TP1 uses whole-position +0.25R lock");
