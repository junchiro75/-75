//+------------------------------------------------------------------+
//| XAU_M2_BB_LIVE_005_RFILTER_V6.mq5                                |
...
int OnInit()
{
   ...
   Log("START",string("TF=M2 | PB=0.10R | SL=2R | own-Magic MAX1 | Magic=")+
       ...
       " | MaxSL_Points="+DoubleToString(MaxSL_Points,1)+
       " | orders="+(EnableLiveOrders?"ENABLED":"DRY"));
   Log("NOTE","RFILTER6 build: RFILTER5 + MaxSL_Points (caps initial SL distance on unusually large-R signals only)");
