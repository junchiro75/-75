"""Runs the hybrid "bear->wait->BUY, bull->immediate BUY" idea for both
005-style (M2) and 007-style (M10) exit economics, full period."""

from .bars import BarBuilder
from .bbands import DualBB
from .hybrid_signals import HybridSignalTracker
...
class HybridRunner:
    def __init__(self):
        ...
        self.m10_signals = HybridSignalTracker(600, 0.95, 0.10, 72, 72)
        self.m2_signals = HybridSignalTracker(120, 0.95, 0.10, 72, 72)

        self.s005 = PositionManager('005_hybrid', lots=0.01, stop_r=2.0, protect_trigger_r=0.5,
                                     protect_r=0.25, tp_r=0.9, tp_relative='entry',
                                     partial_trigger_r=None, timeout_hours=None)
        self.s007 = PositionManager('007_hybrid', lots=0.02, stop_r=2.0, protect_trigger_r=0.5,
