//+------------------------------------------------------------------+
//| XAU_M2_BB_LIVE_005_RFILTER_V1.mq5                                |
...
{
   Print("LIVE005 RFILTER M2 | ",event," | ",detail);
...
int OnInit()
{
   ...
   f_log=FileOpen("XAU_M2_LIVE_005_RFILTER_LOG.csv",FILE_READ|FILE_WRITE|FILE_CSV|FILE_ANSI|FILE_SHARE_READ,',');
   ...
   Log("NOTE","RFILTER build: 005_BUYONLY + MinR_Points signal filter for symbols where the unfiltered edge is negative; live 0.01 TP1 uses whole-position +0.25R lock");
